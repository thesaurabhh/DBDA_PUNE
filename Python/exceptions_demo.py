...
try:
    input_var = int(input("Please enter a number "))
    print("The number you entered is " , input_var)
except Exception:
    try:
        input_var = int(input("You entered an incorrect number , Please try again ! "))
        print("The number you entered second time is " , input_var)
    except :
        input_var = int(input("You stupid please enter a number")) 
        print("The number you entered third time is " , input_var)  

print("Hurray .. Finally we are through this program")   
